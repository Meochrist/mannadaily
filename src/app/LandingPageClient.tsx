            ...
            >
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-emerald-400 text-xs font-black uppercase tracking-wider mt-1">Application PWA & Web</p>
                </div>
                <p className="text-slate-400 text-sm font-semibold leading-relaxed">
                  Accédez directement à MannaDaily et installez-la sur votre écran d'accueil Android en un tap.
                </p>
              </div>
              <div className="space-y-3">
                ...
                <p className="text-xs text-slate-500 font-bold">Ajoutable à l'écran d'accueil</p>
              </div>
            </motion.div>
