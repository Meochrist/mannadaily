        ...
        >
          {!sessionResult ? (
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="space-y-6 w-full flex flex-col items-center">
              ...
              {/* AI Summary — Ce que Dieu t'a dit */}
              {summaryContent && (
                <div className="w-full bg-indigo-950 text-indigo-50 p-6 rounded-3xl border border-indigo-900 shadow-lg space-y-3">
                  <div className="flex items-center gap-2 border-b border-indigo-900/60 pb-2 text-amber-400">
                    <Sparkles className="w-4 h-4 text-amber-400" />
                    <span className="font-black text-xs uppercase tracking-wider">Ce que Dieu t&apos;a dit aujourd&apos;hui</span>
                  </div>
                  <p className="text-indigo-100 font-bold leading-relaxed text-sm text-justify whitespace-pre-line">{summaryContent}</p>
                </div>
              )}
              ...
              <div className="w-full grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-2xl font-black text-amber-500">+{[1, 2, 3].reduce((s, id) => s + (XP_REWARDS[id] || 0), 0)}</span>
                  <p className="text-[10px] font-semibold text-slate-400 mt-0.5">3 mini-sessions complétées</p>
                </div>
                <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center text-center">
